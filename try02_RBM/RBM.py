...
class RBM:
	...
	def __init__(self, n_visible, n_hidden, lr=0.0001, epochs=10, mode='bernoulli', batch_size=4, k=1, optimizer='adam', gpu=False, savefile=None, early_stopping_patience=10):
...
if __name__ == '__main__':
	...
	rbm = RBM(10, 100, epochs=50, mode='bernoulli', lr=0.0001, optimizer='adam', gpu=True, savefile='save_example.pt', early_stopping_patience=50)
